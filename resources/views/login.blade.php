        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-sm-8">
                <div class="card p-5">
                    ...
                    {{-- errors --}}
                    {{-- com o código abaixo é possível mostrar os erros abaixo do botão do login.
                    Eles não serão mostrados logo abaixo dos seus respectivos campos, como implantado acima --}}
                    {{-- @if ($errors->any())
