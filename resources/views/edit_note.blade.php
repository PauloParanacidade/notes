                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control bg-primary text-white" name="text_note" rows="5">{{ old('text_note', $note->text) }}</textarea> {{-- aqui no $note->text foi text por causa do que foi definido na base de dados, tabela notes, campo text--}}
                            {{-- show error --}}
                            @error('text_note')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
